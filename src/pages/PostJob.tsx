      ...
      <main className="flex-1 container py-8 px-4 md:px-6">
        ...
        {showVerificationWarning && (
          <div className="mb-6 p-4 border rounded-lg bg-amber-50 text-amber-800 dark:bg-amber-900/20 dark:text-amber-400 flex items-start">
            ...
            <div>
              <h3 className="font-medium">ID Verification Required</h3>
              <p className="text-sm">
                Your account is not yet verified. Job listings from unverified recruiters may have lower visibility. 
                Please complete the ID verification process to improve your trust score.
              </p>
            </div>
          </div>
        )}
